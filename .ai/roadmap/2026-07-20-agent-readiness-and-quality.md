...
3. Run real-browser QA for public EN/TR routes, accessibility, purposeful alive motion, reduced-motion equivalence, responsive natural flow, and the isolated WASM journey.
