...
The keys live in `.claude/settings.json` (project) or `/Users/ogiboy/Documents/Projects/portfolio-app/.claude/settings.json` (global) — **not** in `.planning/config.json`:
