...
```
Agent(
  prompt="Read /Users/ogiboy/Documents/Projects/portfolio-app/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/ogiboy/Documents/Projects/portfolio-app/.claude/gsd-core/templates/SECURITY.md`
