...
- **Global scope**: `/Users/ogiboy/Documents/Projects/portfolio-app/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/ogiboy/Documents/Projects/portfolio-app/.claude/notes/`)
...
2. Glob `/Users/ogiboy/Documents/Projects/portfolio-app/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/ogiboy/Documents/Projects/portfolio-app/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/ogiboy/Documents/Projects/portfolio-app/.claude/notes/` — works in any directory
