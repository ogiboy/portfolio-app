...
INSTALL_JS_GLOBAL="/Users/ogiboy/Documents/Projects/portfolio-app/.claude/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/ogiboy/Documents/Projects/portfolio-app/.claude/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
