...
@/Users/ogiboy/Documents/Projects/portfolio-app/.claude/gsd-core/references/ui-brand.md
@/Users/ogiboy/Documents/Projects/portfolio-app/.claude/gsd-core/references/revision-loop.md
@/Users/ogiboy/Documents/Projects/portfolio-app/.claude/gsd-core/references/gate-prompts.md
@/Users/ogiboy/Documents/Projects/portfolio-app/.claude/gsd-core/references/agent-contracts.md
@/Users/ogiboy/Documents/Projects/portfolio-app/.claude/gsd-core/references/gates.md
</required_reading>
...
- Planner is instructed to produce `SKELETON.md` in the phase directory alongside `PLAN.md`. The template lives at `/Users/ogiboy/Documents/Projects/portfolio-app/.claude/gsd-core/references/skeleton-template.md` — the planner reads it when producing SKELETON.md (lazy; not loaded on non-skeleton runs).
...
**If found:**
1. Read template: `/Users/ogiboy/Documents/Projects/portfolio-app/.claude/gsd-core/templates/VALIDATION.md`
...
UI_GATE_JS=$(for _c in "$_GSD_RT/gsd-core/bin/lib/ui-safety-gate.cjs" "$_GSD_RT/bin/lib/ui-safety-gate.cjs" "$_GSD_RT/.claude/bin/lib/ui-safety-gate.cjs" "/Users/ogiboy/Documents/Projects/portfolio-app/.claude/gsd-core/bin/lib/ui-safety-gate.cjs" "/Users/ogiboy/Documents/Projects/portfolio-app/.claude/bin/lib/ui-safety-gate.cjs"; do [ -f "$_c" ] && { echo "$_c"; break; }; done)
...
${TDD_MODE === 'true' ? `
<tdd_mode_active>
**TDD Mode is ENABLED.** Apply TDD heuristics from @/Users/ogiboy/Documents/Projects/portfolio-app/.claude/gsd-core/references/tdd.md to all eligible tasks:
...
**MVP_MODE:** ${MVP_MODE} (when true, follow vertical-slice rules from `/Users/ogiboy/Documents/Projects/portfolio-app/.claude/gsd-core/references/planner-mvp-mode.md`; when false, ignore MVP guidance entirely.)
**WALKING_SKELETON:** ${WALKING_SKELETON} (when true, the first deliverable must be a Walking Skeleton — Read the template at `/Users/ogiboy/Documents/Projects/portfolio-app/.claude/gsd-core/references/skeleton-template.md` and produce SKELETON.md alongside PLAN.md.)
**Granularity:** {granularity}

${MVP_MODE === 'true' ? `
<mvp_mode_active>
**MVP Mode is ENABLED.** Read `/Users/ogiboy/Documents/Projects/portfolio-app/.claude/gsd-core/references/planner-mvp-mode.md` now and follow its vertical-slice planning rules. Each plan must deliver a complete vertical slice — thin end-to-end functionality rather than horizontal layers.
</mvp_mode_active>
` : ''}
</planning_context>
