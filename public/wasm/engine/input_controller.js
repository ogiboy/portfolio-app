...
class InputController {
  ...
  initNippleJS() {
    ...
    this.manager.on('move', (evt, data) => {
      ...
      if (data.force > 1 && this.MobileStart) {
        if (data.direction) this.nippleDirection = data.direction.angle;
    ...
    this.manager.on('end', (evt, data) => {
      ...
      const millisecondsDifference = time2 - time1;
      if (millisecondsDifference < 300 && this.nippleForce < 0.5) {
  ...
  setupMobileControls(touch_element_id) {
    if (touch_element_id) {
      ...
      document.getElementById(touch_element_id).addEventListener(
        'touchstart',
        function (e) {
          e.preventDefault();
        },
      ...
      document
        .getElementById('mobileA')
        .addEventListener('touchstart', this.mobilePressA.bind(this), false);
      document
        .getElementById('mobileB')
        .addEventListener('touchstart', this.mobilePressB.bind(this), false);
      document
        .getElementById('mobileStart')
        .addEventListener(
          'touchstart',
          this.mobilePressStart.bind(this),
          false
        );
      document
        ...
        .addEventListener(
          'touchstart',
          this.mobilePressSelect.bind(this),
          false
        );
      document
        .getElementById('mobileA')
        .addEventListener('touchend', this.mobileReleaseA.bind(this), false);
      document
        .getElementById('mobileB')
        .addEventListener('touchend', this.mobileReleaseB.bind(this), false);
      document
        .getElementById('mobileStart')
        .addEventListener(
          'touchend',
          this.mobileReleaseStart.bind(this),
          false
        );
      document
        .getElementById('mobileSelect')
        .addEventListener(
          'touchend',
          this.mobileReleaseSelect.bind(this),
          false
        );
      document.getElementById('mobileA').addEventListener(
        'touchmove',
        function (e) {
          e.preventDefault();
        },
      ...
      document.getElementById('mobileB').addEventListener(
        'touchmove',
        function (e) {
          e.preventDefault();
        },
      ...
      document.getElementById('mobileStart').addEventListener(
        'touchmove',
        function (e) {
          e.preventDefault();
        },
      ...
      document.getElementById('mobileSelect').addEventListener(
        'touchmove',
        function (e) {
          e.preventDefault();
        },
      ...
      document
        ...
        .addEventListener('touchstart', this.menuTouch.bind(this), false);
    }
  }
  ...
  isWithinRange(angle, range) {
    if (range - 5 < angle && angle < range + 5) return true;
    else return false;
  }
  ...
  touchStart(event) {
    ...
    for (let i = 0; i < event.touches.length; i++) {
      ...
      if (
        touch.target['id'] == 'divTouchSurface' ||
        touch.target['id'] == 'startDiv'
      ) {
      ...
      if (
        ...
        if (amount_horizontal > 10) {
          if (!input_controller.Key_Right) {
            input_controller.sendKeyDownEvent(
              input_controller.KeyMappings.Mapping_Right
            );
        ...
        if (amount_horizontal < -10) {
          if (!input_controller.Key_Left) {
            input_controller.sendKeyDownEvent(
              input_controller.KeyMappings.Mapping_Left
            );
        ...
        if (amount_vertical > 10) {
          if (!input_controller.Key_Down) {
            input_controller.sendKeyDownEvent(
              input_controller.KeyMappings.Mapping_Down
            );
        ...
        if (amount_vertical < -10) {
          if (!input_controller.Key_Up) {
            input_controller.sendKeyDownEvent(
              input_controller.KeyMappings.Mapping_Up
            );
  ...
  touchEnd(event) {
    ...
    if (input_controller.Key_Right) {
      input_controller.sendKeyUpEvent(
        input_controller.KeyMappings.Mapping_Right
      );
      input_controller.Key_Right = false;
    }
  ...
  processGamepad() {
    ...
    try {
      ...
      for (let i = 0; i < gamepads.length; i++) {
        if (gamepads[i] && gamepads[i].buttons.length > 0) gp = gamepads[i];
      }
      if (gp) {
  ...
  keyDown(event) {
    ...
    if (!event.type.startsWith('Gamepad')) return;
  ...
  keyUp(event) {
    ...
    let input_controller = this;
    if (this.isNumber(event.keyCode)) {
      input_controller.KeyCodes = input_controller.KeyCodes.filter(
        (item) => item !== event.keyCode
      );
    }
  ...
  updateControls() {
    ...
    if (this.Key_Up) mobileString += '1';
    else mobileString += '0'; //UP
    if (this.Key_Down) mobileString += '1';
    else mobileString += '0'; //DOWN
    if (this.Key_Left) mobileString += '1';
    else mobileString += '0'; //LEFT
    if (this.Key_Right) mobileString += '1';
    else mobileString += '0'; //RIGHT
    ...
    if (mobileMode) {
      ...
      if (this.DragMouse) {
        ...
        if (this.Key_Action_B) mobileString += '1';
        else mobileString += '0';
      }

      // right mouse click
      if (this.Key_Action_A) mobileString += '1';
      else mobileString += '0';
    } else {
      if (this.Key_Action_A) mobileString += '1';
      else mobileString += '0';
    ...
    if (this.Key_Action_Start) mobileString += '1';
    else mobileString += '0';
    if (this.Key_Action_L) mobileString += '1';
    else mobileString += '0';
    if (this.Key_Action_R) mobileString += '1';
    else mobileString += '0';
    if (this.Key_Action_Z) mobileString += '1';
    else mobileString += '0';
