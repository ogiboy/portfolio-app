...
export const siteCopy: LocalizedCopy<{
  ...
  tr: {
    ...
    home: {
      ...
      title: 'Ham ürün fikirlerini kullanılabilir lansmanlara dönüştüren keskin web arayüzleri kuruyorum.',
      subtitle:
      ...
      processIntro:
        'Süreç görünür kararlar, dar kapsamlar ve release öncesi kanıt üzerine kurulu.',
      process: [
        {
          title: 'Çerçevele',
