...
const Navbar = () => {
  ...
  return (
    <nav className="nav text-slate-600 bg-slate-200 dark:bg-slate-700 dark:text-slate-300 w-screen max-h-fit flex justify-between items-center flex-row-reverse fixed top-0 pb-1 border-b border-slate-300 dark:border-slate-800 rounded-sm z-50">
